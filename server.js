...
async function generateAndCache(dokId, title, date, apiKey, debateText = '') {
  ...
  const aiRes = await fetch('https://api.anthropic.com/v1/messages', {
    ...
    body: JSON.stringify({
      ...
      max_tokens: 900,
      messages: [{ role: 'user', content: `Du är politisk reporter med uppdraget att göra riksdagsdebatter levande och begripliga för alla – utan att förenkla det som är viktigt.\n\nDitt mål: läsaren ska känna att något faktiskt stod på spel i den här debatten.\n\nBLOCKTILLHÖRIGHET – strikt:\n- Vänsterblocket: S, V, MP — hamnar ALLTID i vansterblocket\n- Högerblocket: M, SD, KD, L, C — hamnar ALLTID i hogerblocket\n- Om ett block inte deltog: {"parties":[],"summary":"Inget parti från detta block deltog.","keyArg":""}\n\nSPRÅK OCH TON:\n- Formellt men levande – som en skicklig tidningsreporter, inte en tjänsteman\n- Börja med det mest intressanta: ett krav, en konflikt, ett oväntat svar, eller vad som verkligen stod på spel\n- Visa vad som skiljde partierna åt – inte bara att de var oense\n- Aktiv form: "S kräver" inte "ett krav framfördes av S"\n- Konkret och specifikt – nämn det faktiska sakfrågan, inte bara att "en debatt hölls"\n- Max 15 ord per mening. En tanke i taget.\n\nFÖRBJUDET:\n- "lyfte fram", "påpekade att", "menade att", "framhöll"\n- "Med anledning av", "Till följd av", "Vad gäller"\n- "högerblocket", "vänsterblocket", "oppositionen", "regeringen" – använd alltid partinamn (S, M, SD, KD, L, C, V, MP)\n- "Debatten handlade om", "I debatten diskuterades", "Riksdagen debatterade"\n- Upprepade prepositioner: inte "pekar på X, på Y" – skriv två meningar\n\nGRAMMATIK:\n- Perfekt particip: "tvingat" inte "tvingt", "tagit" inte "tagt"\n- Undvik långa bisatser och "som"-kedjor\n\nÖVRIGT:\n- Basera ENBART på texten nedan\n- Om texten uppenbart handlar om ett annat ämne än titeln: svara null\n\nTitel: ${title}\n\n${debateText.slice(0, 18000)}\n\nSvara ENDAST med JSON (eller null):\n{"ingress":"2-3 meningar. Fånga kärnan i konflikten – vad krävdes, vad vägrade man, vad stod på spel. Gör det omöjligt att inte vilja läsa mer.","vansterblocket":{"parties":["partiförkortningar ur S/V/MP"],"summary":"2-3 meningar. Vad de sa och varför det spelar roll – konkret och levande.","keyArg":"2-3 meningar. Hela deras position: vad de vill, varför de vill det, och vad de anser händer om de inte får igenom det."},"hogerblocket":{"parties":["partiförkortningar ur M/SD/KD/L/C"],"summary":"2-3 meningar. Vad de sa och varför det spelar roll – konkret och levande.","keyArg":"2-3 meningar. Hela deras position: vad de vill, varför de vill det, och vad de anser händer om de inte får igenom det."}}` }]
    })
  })
